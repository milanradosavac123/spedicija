            ...
            <Transition.Root show={isOpen} as={Fragment}>
                <Dialog as="div" className="relative z-50" onClose={onClose}>
                    ...
                    >
                        ...
                        >
                            <div
                                className="pointer-events-none fixed inset-y-0 right-0 flex flex-row max-w-full pl-10"
                            >
                                <Transition.Child
                                    as={Fragment}
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            className="flex flex-col h-full overflow-y-scroll bg-white py-6 shadow-xl"
                                        >
                                            <div
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        className="flex flex-row gap-10 my-8"
                                                    >
                                                        <div
